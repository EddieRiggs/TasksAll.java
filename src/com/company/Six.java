...
public class Six {
    public static void main(String[] args){
        ...
        System.out.println("\t\t\t56 subtask");
        System.out.println(ulam(4));
        System.out.println(ulam(9));
        System.out.println(ulam(206));
        System.out.println("\t\t\t57 subtask");
